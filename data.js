...
var printers_bw = [
    // ['aap-nyc-1bw','NYTech (direct print; card reader)','campus-bw, campus-color','40.755805','-73.956233',null], // m // similar listed in color
    ...
    // ['bin1/bin2/bin3','Statler Hall 365 - by the lab monitor desk - second through fourth from window','campus-bw','42.4454727','-76.48206789999999', null], // similar listed in color
    ...
    // ['cit-rpcc-1bw/cit-rpcc-2bw','Robert Purcell Community Center - RPCC - Computer Lab - Room 207','campus-bw, campus-color','42.4562967','-76.4783146',{0:[9,23.99],1:[9,23.99],2:[9,23.99],3:[9,23.99],4:[9,23.99],5:[11,23.99],6:[12,23.99]}], // similar listed in color
    ...
    // ['cit-uris-1bw/cit-uris-2bw','Uris Library - Tower Room Computer Lab - Downstairs from Entrance','campus-bw, campus-color','42.447905','-76.484293',{0:[8,25],1:[8,25],2:[8,25],3:[8,25],4:[8,21],5:[12,21],6:[10,25]}], // similar listed in color
    ...
    // ['ciw2','District of Columbia - Cornell in Washington','campus-bw, campus-color','38.908391', '-77.048506' ,null], // m // similar listed in color
    ...
    // ['mann1/mann2/mann3','Mann Library - First Floor','campus-bw, campus-color','42.4487577','-76.47631179999999',{0:[8,24],1:[8,24],2:[8,24],3:[8,24],4:[8,18],5:[12,19],6:[12,24]}],  // similar listed in color
    ...
    // ['sage-lib1-bw/sage-lib2-bw','Sage Hall - Library - First Floor','campus-bw','42.4458918','-76.4833009',{0:[7,21],1:[7,21],2:[7,21],3:[7,21],4:[7,21],5:[7,21],6:[7,21]}], // similar listed in color
    ...
    // ['uris-lib1','Uris Library - In Front of Circulation Desk','campus-bw, campus-color','42.447905','-76.484293',{0:[8,25],1:[8,25],2:[8,25],3:[8,25],4:[8,21],5:[12,21],6:[10,25]}], // similar listed in color
    // ['uris-lib3','Uris Library - Austen Room','campus-bw, campus-color','42.447905','-76.484293',{0:[8,25],1:[8,25],2:[8,25],3:[8,25],4:[8,21],5:[12,21],6:[10,25]}], // similar listed in color
